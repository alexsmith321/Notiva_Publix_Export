...
ColumnLayout {
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            Image {
                id: clef
                source: "Common/Images/treble-clef-manuscript-style.png"
    ...
    RowLayout {
        ...
        MainButton {
            ...
            mainButtonText: "Back"
            mainButtonClicked.onClicked: loaderSource = "SetGoal.qml"
        }
        ...
        MainButton {
            ...
            mainButtonClicked.onClicked: {
                ...
                loader.source = "BassSettings.qml"
            }
        }
